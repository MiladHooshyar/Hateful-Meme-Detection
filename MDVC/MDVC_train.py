...
test_data = os.path.dirname(dirname) + '/data/dev.pickle'
...
dataset_test = MDVC_model.load_data(test_data, feature_list)
...
writer = SummaryWriter(log_dir='C:/Users/milad/PycharmProjects/Hateful_meme/MDVC/runs/MH')
